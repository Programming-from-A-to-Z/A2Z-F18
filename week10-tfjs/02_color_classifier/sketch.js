...
let labelList = ['red-ish', 'green-ish', 'blue-ish', 'orange-ish', 'yellow-ish', 'pink-ish', 'purple-ish', 'brown-ish', 'grey-ish'];
  ...
  const config = {
    ...
    callbacks: {
      onEpochEnd: (epoch, logs) => {
        lossP.html(`Epoch: ${epoch + 1}<br/>Loss: ${logs.loss.toFixed(5)}`);
      },
